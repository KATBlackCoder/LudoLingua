  ...
  <UCard>
    <template #header>
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Translation Management</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Comprehensive translation workflow</p>
          </div>
        </div>
    ...
    <div class="space-y-6">
      ...
      <UCard>
        <template #header>
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Overview</span>
          </div>
        </template>
      ...
      <UCard>
        <template #header>
          <div class="flex items-center gap-2">
            <UIcon name="i-lucide-workflow" class="text-gray-500 w-4 h-4" />
            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Translation Workflow</span>
          </div>
        </template>
        <div class="space-y-4">
      ...
      <UCard>
        <template #header>
          <div class="flex items-center gap-2">
            <UIcon name="i-lucide-list-checks" class="text-gray-500 w-4 h-4" />
            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Management Features</span>
          </div>
        </template>
      ...
      <UCard>
        <template #header>
          <div class="flex items-center gap-2">
            <UIcon name="i-lucide-tags" class="text-gray-500 w-4 h-4" />
      ...
      <UCard>
        <template #header>
          <div class="flex items-center gap-2">
            <UIcon name="i-lucide-message-square-text" class="text-gray-500 w-4 h-4" />
            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Content Types</span>
          </div>
        </template>
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
          <UBadge color="secondary" variant="soft" class="justify-center">Character</UBadge>
          <UBadge color="secondary" variant="soft" class="justify-center">Dialogue</UBadge>
          <UBadge color="secondary" variant="soft" class="justify-center">System</UBadge>
          <UBadge color="secondary" variant="soft" class="justify-center">Equipment</UBadge>
          <UBadge color="secondary" variant="soft" class="justify-center">Skill</UBadge>
          <UBadge color="secondary" variant="soft" class="justify-center">Class</UBadge>
          <UBadge color="secondary" variant="soft" class="justify-center">State</UBadge>
          <UBadge color="secondary" variant="soft" class="justify-center">Other</UBadge>
        </div>
        <div class="mt-3">
          <p class="text-sm text-muted">
            Each text unit is categorized by content type, allowing for specialized translation prompts and better organization.
          </p>
        </div>
      </UCard>
      ...
      <UAlert color="info" variant="soft" icon="i-lucide-lightbulb">
        <template #title>Tips for Managing Translations</template>
        <template #description>
          <ul class="text-sm space-y-1 mt-2">
            <li>• Use filters to focus on specific content types or translation statuses</li>
            <li>• Review machine translations and mark them as "Human Reviewed" when verified</li>
